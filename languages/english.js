...
module.exports = {
    ...
    utils: {
        ...
        viewConf: () => `[View the configuration on the dashboard](https://delta-bot.com)`,
        conf: {
            title: () => `View the configuration on the dashboard`,
            content: () => `[or on the dashboard](https://delta-bot.com)`
        },
        specialMessages: {
            join: {
    ...
    botinfos: {
        ...
        statistics: {
            title: () => `📊 Statistics`,
            content: (guilds, users, channels) => `\`Servers: ${guilds}\`\n\`channels: ${channels}\`\n\`Users: ${users}\``
        },
        // Versions
        versions: {
            title: () => `⚙️ Versions`,
...
:pencil: **| Now write the leave message... :pencil2:**`,
    ...
    ranks: {
        ...
        description: () => `Here are the invitation rewards`
    },

    website: {
        doc: {
            variables: () => `https://https://delta-bot.com/configuration/variables`
        },
        utils: {
            members: () => `members`
        },
